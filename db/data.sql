...
('egg',      'Trứng gà',     'Nguyên liệu', 70,  6.3,  0.4, 4.8,  'Protein cao, vitamin D, choline',          'Giàu protein, tốt cho cơ bắp',  '/images/foods/egg.jpg', 6,   'quả', 14, FALSE, CURRENT_TIMESTAMP),
('chicken',  'Ức gà',        'Nguyên liệu', 165, 31,   0,   3.6,  'Đạm cao, ít béo, sắt, kẽm',                'Tăng cơ, kiểm soát cân nặng',   '/images/foods/chicken.jpg', 450, 'g',    4,  FALSE, CURRENT_TIMESTAMP),
('beef',     'Thịt bò',      'Nguyên liệu', 250, 26,   0,   15,   'Đạm, sắt hema, vitamin B6, B12',           'Bổ máu, phát triển cơ bắp',     '/images/foods/beef.jpg', 300, 'g',    5,  FALSE, CURRENT_TIMESTAMP),
('pork',     'Thịt heo',     'Nguyên liệu', 242, 27,   0,   14,   'Vitamin B1, kẽm, phốt pho',                'Giàu năng lượng, thơm ngon',    '/images/foods/pork.jpg', 400, 'g',    5,  FALSE, CURRENT_TIMESTAMP),
('salmon',   'Cá hồi',       'Nguyên liệu', 208, 20,   0,   13,   'Axit béo Omega-3, DHA, vitamin D',         'Tốt cho tim mạch và trí não',   '/images/foods/salmon.jpg', 300, 'g',    4,  FALSE, CURRENT_TIMESTAMP),
('shrimp',   'Tôm tươi',     'Nguyên liệu', 99,  24,   0.2, 0.3,  'Canxi, đạm, iot, selen',                   'Chắc xương, ít béo',            '/images/foods/shrimp.jpg', 300, 'g',    3,  FALSE, CURRENT_TIMESTAMP),
('tomato',   'Cà chua',      'Rau Củ',      22,  0.9,  3.9, 0.2,  'Nước, lycopene, vitamin C, kali',          'Đẹp da, chống oxy hoá',         '/images/foods/tomato.jpg', 4,   'quả',  7,  FALSE, CURRENT_TIMESTAMP),
('broccoli', 'Bông cải xanh','Rau Củ',      34,  2.8,  6.6, 0.4,  'Chất xơ, vitamin C, vitamin K',            'Thanh lọc cơ thể, ít calo',     '/images/foods/broccoli.jpg', 250, 'g',    6,  FALSE, CURRENT_TIMESTAMP),
('carrot',   'Cà rốt',       'Rau Củ',      41,  0.9,  9.6, 0.2,  'Beta-carotene, vitamin A, chất xơ',        'Tốt cho thị lực, miễn dịch',    '/images/foods/carrot.jpg', 3,   'củ',   14, FALSE, CURRENT_TIMESTAMP),
('potato',   'Khoai tây',    'Rau Củ',      77,  2,    17,  0.1,  'Tinh bột kháng, kali, vitamin B6',         'Bổ sung năng lượng lành mạnh',  '/images/foods/potato.jpg', 4,   'củ',   21, FALSE, CURRENT_TIMESTAMP),
('shallot',  'Hành tím',     'Gia vị',      40,  1.1,  9.3, 0.1,  'Flavonoid, hợp chất lưu huỳnh',            'Kháng viêm, tăng hương vị',     '/images/foods/shallot.jpg', 5,   'củ',   30, FALSE, CURRENT_TIMESTAMP),
('garlic',   'Tỏi',          'Gia vị',      149, 6.4,  33,  0.5,  'Allicin, chất chống oxy hóa',              'Tăng cường miễn dịch, tiêu hoá', '/images/foods/garlic.jpg', 3,   'củ',   45, FALSE, CURRENT_TIMESTAMP),
('ginger',   'Gừng tươi',    'Gia vị',      80,  1.8,  18,  0.8,  'Gingerol, tinh dầu gừng',                  'Ấm bụng, giảm viêm, chống cảm', '/images/foods/ginger.jpg', 2,   'củ',   30, FALSE, CURRENT_TIMESTAMP),
('milk',     'Sữa tươi',     'Nguyên liệu', 120, 8,    12,  5,    'Canxi, vitamin D, protein casein',         'Chắc khỏe xương và răng',       '/images/foods/milk.jpg', 1,   'lít',  7,  FALSE, CURRENT_TIMESTAMP),
('yogurt',   'Sữa chua',     'Nguyên liệu', 95,  10,   3.6, 0.4,  'Men vi sinh Probiotic, protein',           'Hỗ trợ tiêu hóa đường ruột',    '/images/foods/yogurt.jpg', 4,   'hộp',  10, FALSE, CURRENT_TIMESTAMP),
('avocado',  'Quả bơ',       'Trái Cây',    160, 2,    8.5, 14.7, 'Chất béo không bão hòa đơn, kali',        'Tốt cho tim mạch, no lâu',      '/images/foods/avocado.jpg', 2,   'quả',  5,  FALSE, CURRENT_TIMESTAMP),
('banana',   'Chuối',        'Trái Cây',    89,  1.1,  22.8,0.3,  'Kali, carbohydrate phức hợp',              'Bổ sung năng lượng tức thì',    '/images/foods/banana.jpg', 5,   'quả',  6,  FALSE, CURRENT_TIMESTAMP),
('rice',     'Cơm trắng',    'Nguyên liệu', 130, 2.7,  28,  0.3,  'Carbohydrate, tinh bột',                   'Nguồn tinh bột chính bữa ăn',   '/images/foods/rice.jpg', 500, 'g',    3,  FALSE, CURRENT_TIMESTAMP),
('tofu',     'Đậu hũ',       'Nguyên liệu', 76,  8,    2,   4.5,  'Protein thực vật, isoflavone',             'Đạm thực vật thanh đạm',        '/images/foods/tofu.jpg', 2,   'hộp',  5,  FALSE, CURRENT_TIMESTAMP),
('cheese',   'Phô mai',      'Nguyên liệu', 402, 25,   1.3, 33,   'Canxi, chất béo, protein',                 'Giàu năng lượng, béo thơm',     '/images/foods/cheese.jpg', 200, 'g',    30, FALSE, CURRENT_TIMESTAMP);
